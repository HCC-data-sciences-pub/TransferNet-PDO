...
4. Supplement the .slurm files with proper information in the downloaded Infer directory from this repository
...
6. Predict PDO types via majoirty voting using: function
