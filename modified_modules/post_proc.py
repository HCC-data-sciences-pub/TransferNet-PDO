...
def process(pred_map, nr_types=None, return_centroids=False):
    ...
    if nr_types is not None:
        ...
        for inst_id in list(inst_info_dict.keys()):
            ...
            # custom added probs for all pixel types for roc plot !!!
            type_probs ={}
            for  tuple_ in type_list:
                type_probs[str(tuple_[0])] =  float( tuple_[1] / (np.sum(inst_map_crop) + 1.0e-6))
            ...
            inst_info_dict[inst_id]["type_probs"] = type_probs 
